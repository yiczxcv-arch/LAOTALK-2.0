/**
 * 카드 미리보기 영상(유튜브) 단일 소스.
 * key는 콘텐츠 id와 일치해야 한다 — 숙소: stay.id, 액티비티: activity.id, 골프: "golf-premium"(HOME 프리미엄 골프 배너 고정 키).
...
export const previewVideos: Partial<Record<string, PreviewVideo>> = {
  // 예시: "stay-1": { youtubeId: "여기에_유튜브_영상ID", title: "프리미엄 호텔 30초 미리보기" },
};
